...
class HGCALShowerBasedEmIdentificationLC2
{
  ...
  math::XYZPoint startPosition(const reco::PFCluster& clu,const edm::SortedCollection<HGCRecHit>& rcs  );
  double sigmaetaeta(const reco::PFCluster& clu,const  edm::SortedCollection<HGCRecHit>& rcs  );
  double lengthCompatibility(const reco::PFCluster& clu,const  edm::SortedCollection<HGCRecHit>& rcs  );
